...
ratingSchema.post('save', async function() {
  try {
    ...
    if (ratings.length > 0) {
      ...
      // Actualizar estadísticas del usuario solo si el tipo de calificación coincide con su rol actual
      // O si el usuario puede tener ambos roles, actualizar según el tipo de calificación
