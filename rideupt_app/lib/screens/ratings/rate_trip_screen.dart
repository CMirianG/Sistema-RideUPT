...
class _RateTripScreenState extends State<RateTripScreen> {
  ...
  void _navigateBack() {
    ...
    // Para ambos casos (conductor y pasajero), usar pushReplacement 
    // para evitar pantalla negra y asegurar que siempre haya una pantalla válida en el stack
      ...
      if (allSuccess && mounted) {
        ...
        if (mounted) {
          ...
          if (remainingUsers.isEmpty) {
            // No hay más usuarios para calificar, navegar de vuelta
            _navigateBack();
          }
